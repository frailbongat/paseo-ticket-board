...
/**
 * A glyph per kind, and there are two kinds.
 *
 ...
 */
const KIND_ICONS: Record<TicketKind, string> = {
  wayfinder: "Compass",
  implement: "Hammer",
};
...
/** The chip color for a kind. Both of them read as the accent. */
export function kindTint(_kind: TicketKind, theme: PluginTheme): string {
  return theme.colors.accent;
}

/** `wayfinder:map` reads as `map` once the kind chip carries the family. */
